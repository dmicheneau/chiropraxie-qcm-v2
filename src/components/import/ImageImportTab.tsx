...
import { Image, Upload, AlertCircle, CheckCircle, Sparkles } from 'lucide-react'
...
export function ImageImportTab() {
  ...
  const handleExtract = async () => {
    ...
    try {
      const result = await extractTextFromImage(selectedFile, setOcrProgress)
      ...
      <div className="card bg-base-100 shadow">
        <div className="card-body">
          ...
          <p className="text-sm text-base-content/70 mb-4">
            Prenez en photo vos notes de cours ou scannez vos documents pour en extraire le texte.
          </p>
          ...
          {selectedFile && !extractedText && (
            <div className="mt-4">
              ...
              >
                {isExtracting ? (
                  <>
                    ...
                    {ocrProgress?.message || 'Reconnaissance...'}
                  </>
                ) : (
                  <>
              ...
              {isExtracting && ocrProgress && ocrProgress.progress > 0 && (
                <progress 
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end mt-4">
              <button
                ...
                disabled={!ollamaStatus.available || !ollamaStatus.modelInstalled || isGenerating || extractedText.length < 50}
              >
                {isGenerating ? (
                  <>
                    <span className="loading loading-spinner loading-sm" />
